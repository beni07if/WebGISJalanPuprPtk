    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                ...
                <p>
                    Kementerian Lingkungan Hidup dan Kehutanan telah mengeluarkan 20 SK untuk areal perhutanan sosial di Kabupaten Ketapang dengan skema Hutan Desa (18 SK) memiliki luas 63.425 hektar dan Hutan Kemasyarakatan (2 SK) memiliki luas 1.778 hektar. Total luasan Perhutanan Sosial di Kabupaten Ketapang sebesar 65.203 Hektar (sumber data UPT KPH Wilayah Ketapang Selatan dan UPT KPH Wilayah Ketapang Utara).
                </p>
                <!-- <p>
