            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                    <div class="text-center text-lg-start">
                        ...
                        <a href="assets/img/galery/video-psktp.mp4" target="_blank" class="glightbox btn-watch-video btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center"><i class="bi bi-play-circle"></i><span>Video Singkat PS Ketapang</span></a>
                    </div>
                </div>
            </div>
