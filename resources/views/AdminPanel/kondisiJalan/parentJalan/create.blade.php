...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Tambah Jalan Induk</a>
    </li>
</ul>
        ...
        <div class="card-body">
            <div class="col-md-8">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Data Jalan Induk</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ route('parent-jalan.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_ruas" id="nama_ruas" placeholder="..">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="provinsi" style="width: 100%;">
                                        <option selected="selected">Kalimantan Barat</option>
                                    </select>
                                </div>
                            </div>
                        </div>
