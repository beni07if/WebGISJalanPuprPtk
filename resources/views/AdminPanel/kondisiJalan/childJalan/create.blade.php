...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Tambah Anak Jalan</a>
    </li>
</ul>
        ...
        <div class="card-body">
            <div class="col-md-8">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Data Kondisi Jalan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ route('child-jalan.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select class="form-control select2" name="parentjalan_id" style="width: 100%;">
                                        ...
                                        <option selected="selected" value="{{$jalan->id}}">{{$jalan->nomor_ruas}} / {{$jalan->nama_ruas}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="patok_dari" id="patok_dari" placeholder="..">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="patok_ke" class="col-sm-3 col-form-label">Patok Ke</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="patok_ke" id="patok_ke" placeholder="..">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="lebar" id="lebar" placeholder="..">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kondisi_jalan" class="col-sm-3 col-form-label">Kondisi Jalan</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="kondisi_jalan" id="kondisi_jalan" placeholder="..">
                                </div>
                            </div>
                            <div class="form-group row" hidden>
                                <label for="panjang_total" class="col-sm-3 col-form-label">Panjang Total (KM)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="panjang_total" id="panjang_total" placeholder="..">
                                </div>
                            </div>
                        </div>
