...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Tambah Dokumentasi</a>
    </li>
</ul>
        ...
        <div class="card-body">
            <div class="col-md-8">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ route('dokumentasi.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_ruas" id="nama_ruas" placeholder="Nama Ruas">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name="dokumentasi" id="dokumentasi" placeholder="..">
                                </div>
                            </div>
                        </div>
